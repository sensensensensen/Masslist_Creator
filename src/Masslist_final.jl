...
module ChemUtils
    ...
    # Central control for formula generation rules. 
    # Edit values here to adjust filtering logic.
    Base.@kwdef struct FormulaConfig
        # --- 1. Atomic Count Limits (Max number of atoms) ---
        max_C::Int = 40
        max_H::Int = 80
        max_N::Int = 2      # Limit to 2 to reduce noise (sufficient for atmospheric nitrates)
        max_O::Int = 30
        max_S::Int = 2
        max_Si::Int = 2
